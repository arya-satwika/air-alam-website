        ...
        <div className="flex gap-8">
          <Link
            ...
            className={`text-sm font-medium transition-colors duration-200 ${
              currentPage === "/" ? "text-[#1a8fe3]" : "text-[#4a5568] hover:text-[#1a8fe3]"
            }`}
          >
            Home
          </Link>
          <Link
            href="/tentang"
            className={`text-sm font-medium transition-colors duration-200 ${
              currentPage === "/tentang" ? "text-[#1a8fe3]" : "text-[#4a5568] hover:text-[#1a8fe3]"
            }`}
          >
            Tentang
          </Link>
          <Link
            href="/brand"
            className={`text-sm font-medium transition-colors duration-200 ${
              currentPage === "/brand" ? "text-[#1a8fe3]" : "text-[#4a5568] hover:text-[#1a8fe3]"
            }`}
          >
            Brand
          </Link>
          <Link
            href="/produk"
            className={`text-sm font-medium transition-colors duration-200 ${
              currentPage === "/produk" ? "text-[#1a8fe3]" : "text-[#4a5568] hover:text-[#1a8fe3]"
            }`}
          >
            Produk
          </Link>
          <Link
            href="/kontak"
            className={`text-sm font-medium transition-colors duration-200 ${
              currentPage === "/kontak" ? "text-[#1a8fe3]" : "text-[#4a5568] hover:text-[#1a8fe3]"
            }`}
          >
            Kontak
          </Link>
